...
import numpy as np
IMAGE_PATH = "path/to/winoground/images/ex_{}_img_{}.png"
...
def get_matching(row_id, caption_id, image_id):
    f = open("../winoground_matching/{}_caption{}_image{}.json".format(row_id, caption_id, image_id))
    result = json.load(f)
    return result    

def get_sentence_json(row_id, caption_id):
    f = open("../winoground_text_json/{}_{}.json".format(row_id, caption_id))
    result = json.load(f)
...
def create_sub_image_obj(row_id, caption_id, image_id):
    object_image = {}
    old_key_to_new_key = {}
    matched_objects = get_matching(row_id, caption_id, image_id)
    image = Image.open(IMAGE_PATH .format(row_id, image_id))
    f = open("../winoground_caption_json/ex_{}_img_{}.json".format(row_id, image_id))
    attributes = open("../winoground_text_json/{}_{}.json".format(row_id, caption_id))
